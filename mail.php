        ...
        <script type="text/javascript">
            ...
            function load() {
                ...
                if (GBrowserIsCompatible()) {
                    ...
                    // à¸?à¸³à¸«à¸?à¸” DIV tag à¸ªà¸³à¸«à¸£à¸±à¸? Map à¹?à¸”à¸¢à¹€à¸?à¹?à¸²à¸–à¸¶à¸?à¹?à¸?à¸? DOM

                    var map = new GMap2(document.getElementById("map"));

                    // Add Map Control à¹?à¸¥à¸° Map Type

                    map.addControl(new GSmallMapControl());

                    map.addControl(new GMapTypeControl());

                    // à¸?à¸³à¸«à¸?à¸” à¸?à¹?à¸²à¸?à¸´à¸?à¸±à¸”à¸?à¸­à¸?à¸•à¸³à¹?à¸«à¸?à¹?à¸?à¹€à¸£à¸´à¹?à¸¡à¸•à¹?à¸?à¸?à¸?à¹?à¸?à¸?à¸—à¸µà¹? 
                    ...
                    //à¹€à¸¡à¸·à¹?à¸­à¹€à¸¥à¸·à¹?à¸­à¸?à¹?à¸¡à¸? à¸?à¸°à¹?à¸ªà¸”à¸? long lat à¹?à¸•à¹?à¸ à¸²à¸?
                    /*GEvent.addListener(map, "moveend", function() {
                  var center = map.getCenter();
                  document.getElementById("message").innerHTML = center.toString();
                });*/
		
                    //click à¹?à¸¥à¹?à¸§à¹?à¸ªà¸”à¸?à¸—à¸µà¹? mark à¹?à¸§à¹?
                  ...
                  if (latlng) {   
                    ...
                    var myHtml = "Latitude : " +lat + "Longtitude : " + lng + "<br>"+ "à¸•à¹?à¸­à¸?à¸?à¸²à¸£à¸?à¸¸à¸”à¸«à¸¡à¸²à¸¢à¸—à¸µà¹?à¸?à¸µà¹? à¸?à¸¥à¸´à¹?à¸? :<br> <input type='button' onClick='javascript:Addpoint("+lat+","+lng+");' value='à¸—à¸³à¸?à¸²à¸£à¸?à¸±à¸?à¸—à¸¶à¸?'>";
            ...
            function driver(){
                ...
                document.getElementById("mail").innerHTML=
                    "<p align='left'> <span class='style14'>à¸?à¹?à¸­à¸¡à¸¹à¸¥à¸?à¸?à¸?à¸±à¸?à¸£à¸–</span> </p>"
...
<?php //} mysql_close($cn); ?>
    ...
    function car(){
        ...
        "<p align='left'> <span class='style14'>à¸?à¹?à¸­à¸¡à¸¹à¸¥à¸£à¸–à¸¢à¸?à¸•à¹?</span> </p>" 
<?php
$cn = @mysql_connect("localhost", "root", "adminadmin");
if (!$cn) {
    echo "fail<br>";
                    ...
                    <div id="krop">
                        <div id="tablena">
                            ...
                            <table width="100%" height="504" border="0">
                                <tr>
                                    <th height="30" bgcolor="#666666" scope="row"><span class="style2"> à¹€à¸?à¹?à¸²à¸ªà¸¹à¹?à¸«à¸?à¹?à¸²à¸•à¸´à¸”à¸•à¸²à¸¡à¸£à¸°à¸?à¸? &nbsp;&nbsp;<img src="header_login_button.png" width="48" height="17" /></span></th>
                                </tr>
                                <tr>
                                    <th height="26" bgcolor="#CCCCCC" scope="row"><div align="left" style="padding-left: 12px"><span class="style10"><a href="#" onclick="driver()" class="link2">à¸?à¸£à¸°à¸§à¸±à¸•à¸´à¸?à¸?à¸?à¸±à¸?</a></span></div></th>
                                </tr>
                                <tr>
                                    <th height="26" bgcolor="#CCCCCC" scope="row"><div align="left" style="padding-left: 12px"><span class="style10"><a href="#" onclick="car()" class="link2">à¸?à¸£à¸°à¸§à¸±à¸•à¸´à¸£à¸–à¸¢à¸?à¸•à¹?</a></span></div></th>
                                </tr>
                                <tr>
                                    <th height="25" bgcolor="#CCCCCC" scope="row"><div align="left" style="padding-left: 12px"><span class="style10"><a href="javascript:void(0)"onclick="window.open('create_driver.php','link','height=380, width=300,scrollbars=no')"  class="link2">à¹€à¸?à¸´à¹?à¸¡à¸?à¹?à¸­à¸¡à¸¹à¸¥à¸?à¸?à¸?à¸±à¸?</a></span></div></th>
                                </tr>
                                <tr>
                                    <th height="29" bgcolor="#CCCCCC" scope="row"><div align="left" style="padding-left: 12px"><span class="style10"><a href="javascript:void(0)"onclick="window.open('create_car.php','link','height=380, width=300,scrollbars=no')"  class="link2">à¹€à¸?à¸´à¹?à¸¡à¸?à¹?à¸­à¸¡à¸¹à¸¥à¸£à¸–</a></span></div></th>
                                </tr>
                                <tr>
                                    <th height="26"  bgcolor="#CCCCCC" scope="row"><div align="left" style="padding-left: 12px"><span class="style8"><a href="javascript:void(0)" class="link2"onclick="window.open('create_trip2.php','link','height=650, width=1000,scrollbars=no')">à¹€à¸?à¸´à¹?à¸¡à¸?à¸²à¸£à¹€à¸”à¸´à¸?à¸—à¸²à¸?à¹?à¸«à¸¡à¹?</a></span><a href="javascript:void(0)" class="link2"onclick="window.open('create_trip.php','link','height=600, width=1000,scrollbars=no')"></a></span> </div></th>
                                </tr>
