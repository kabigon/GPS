...
<style type = "text/css">
#body {color:#FFFFFF;}
#present {background-color:#CCCCCC;color:#000000;}
#centertop {float:right;font-size:12px}
#center{}
h1 {
...
<body bgcolor="#FF9900">
<div id="body">
<b><font size="+2">GPS Tracking Server</b>


<div id="centertop">
<input type="submit"  value="ตำแหน่งปัจจุบัน"/>
<input type="submit"  value="เส้นทางข้อมูลย้อนหลัง"/>
<input type="submit"  value="รายงาน"/>
<input type="submit"  value="จุดสนใจ"/>
<input type="submit"  value="Setting" />
<b>User : <input type="text" name="username" size="10"/>
Pass : <input type="password" name="password" size="10"/></b>
<input type="submit" value="Login" />
</div></div><hr /><br />
<div id="center">
<div style="width: 600px;" class="tekst"></div>
	...
	<?php
		...
		$cn = @mysql_connect("127.0.0.1","root","adminadmin");
	...
	var setLat = parseFloat(<?php echo $lat ?>);
	var setLon = parseFloat(<?php echo $long ?>);
