...
Start Point  <input type="text" name="location1" id="location1" onKeyUp ="showHint()"size="30" value="ใส่สถานที่ ถนน" onfocus="this.value=''"/><br /><div id="txtHint" ></div><br /> lattitude :<input type="text" name="start_lat" id="start_lat" /><br />
