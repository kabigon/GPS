...
while ($row = mysql_fetch_array($result)) {
	...
	if($row["finish_time"] !="0000-00-00 00:00:00" and $check !=0){echo"<img src='../img_status/greencar.png' width='31' height='25' />"; }if($row["finish_time"] =="0000-00-00 00:00:00" and $check !=0){ echo"<img src='../img_status/orangecar.png' width='31' height='25' />";}?></td></tr>"
...
<body onload="initialize()" onunload="GUnload()" style="font-family: Arial;border: 0 none;">
    <div id="page">
        ...
        <div id="menu">
            <ul>
                <li><a href="index-member.php">Home</a></li>
        ...
        <div id="main">
            <div id="sidebar">
                ...
                <h2><span class="thsarabunnew">Recentry Trip </span></h2>
                <ul>
				<?php
                  $cn = @mysql_connect("localhost", "root", "adminadmin");
                  $i = 0;
                  mysql_select_db("gps", $cn);
                  $sql = "SELECT * FROM gps.trip where create_by='".$_SESSION["user"]."' order by trip_id desc";
